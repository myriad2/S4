...
-- Material definition
S:AddMaterial("Dielectric", {1.5^2,0}) -- real and imag parts
S:AddMaterial("Vacuum", {1,0})

--S:AddLayer('Above',0.0,'Vacuum')
S:AddLayer(
	'Above', --name
	0,          --thickness
	'Vacuum')   --background material
S:AddLayer('Slab', 1, 'Dielectric')   -- It is important, without it you may got all zero coefficients
...
--angle = 60.5
	...
	inc1,backwrad1,forward1 = nil  -- It doesnot work
end
